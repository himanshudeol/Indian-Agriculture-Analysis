...
**Dataset:**
The primary dataset used in this analysis is the "ICRISAT-District Level Data.csv" file, sourced from the ICRISAT Dataverse (https://doi.org/10.21421/D2/XFB1BZ).  This dataset includes annual data on area (in thousands of hectares), production (in thousands of tons), and yield (in kg per hectare) for various crops, including cereals, pulses, oilseeds, cotton, sugarcane, fruits, and vegetables, at the district level.
